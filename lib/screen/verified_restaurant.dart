...
class VerifiedRestaurant extends StatefulWidget {
  const VerifiedRestaurant({Key? key}) : super(key: key);
  static const String id = 'verified-restaurant';

  @override
  _VerifiedRestaurantState createState() => _VerifiedRestaurantState();
}

class _VerifiedRestaurantState extends State<VerifiedRestaurant> {
  List<ReadrestaurantModel> readrestaurantModels = [];
  @override
  @override
  void initState() {
    super.initState();
    readRestaurantverified();
  }

  Future<Null> readRestaurantverified() async {
    var url =
        'http://localhost/my_login_rrs/getRestaurantFromchooseTypeAndapprove.php?isAdd=true&chooseType=&shop';
  ...
  Widget build(BuildContext context) {
    ...
    return AdminScaffold(
        ...
        // ),
        sideBar: _sideBar.sideBarMenus(context, VerifiedRestaurant.id),
