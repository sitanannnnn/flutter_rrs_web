...
class UnverifiedRestaurant extends StatefulWidget {
  const UnverifiedRestaurant({Key? key}) : super(key: key);
  static const String id = 'unverified-restaurant';

  @override
  _UnverifiedRestaurantState createState() => _UnverifiedRestaurantState();
}

class _UnverifiedRestaurantState extends State<UnverifiedRestaurant> {
  List<ReadrestaurantModel> readrestaurantModels = [];
  @override
  @override
  void initState() {
    super.initState();
    readRestaurantunverified();
  }

  Future<Null> readRestaurantunverified() async {
    var url =
        'http://localhost/my_login_rrs/getRestaurantFromchooseTypeAndunapprove.php?isAdd=true&chooseType=&shop';
  ...
  Widget build(BuildContext context) {
    ...
    return AdminScaffold(
        ...
        // ),
        sideBar: _sideBar.sideBarMenus(context, UnverifiedRestaurant.id),
